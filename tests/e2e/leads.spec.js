...
test('não deve cadastrar com e-mail incorreto', async ({ page }) => {
  await page.landing.visit();
  await page.landing.openLeadModal();
  await page.landing.submitLeadForm('Yuri Moreira', 'yuri.com.br')
...
test('não deve cadastrar quando o nome não é preenchido', async ({ page }) => {
  await page.landing.visit();
  await page.landing.openLeadModal();
  await page.landing.submitLeadForm('', 'yuri@gmail.com')
...
test('não deve cadastrar quando o e-mail não é preenchido', async ({ page }) => {
  await page.landing.visit();
  await page.landing.openLeadModal();
  await page.landing.submitLeadForm('Yuri Moreira', '')
